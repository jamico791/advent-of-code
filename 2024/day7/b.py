...
def main():
    ...
    for line in lines:
        ...
        results_pointer = 1
        results[0] = [equation_numbers[0] + equation_numbers[1], equation_numbers[0] * equation_numbers[1], int(str(equation_numbers[0]) + str(equation_numbers[1]))]
        while equation_numbers_pointer < len(equation_numbers):
            ...
            for result in results[results_pointer-1]:
                ...
                results[results_pointer].append(result * equation_numbers[equation_numbers_pointer])
                results[results_pointer].append(int(str(result) + str(equation_numbers[equation_numbers_pointer])))
            results_pointer += 1
